defmodule Yap.Accounts do
  ...
  alias Yap.Accounts.{User, UserToken, UserNotifier}
  ...
  See `Yap.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `Yap.Accounts.User.password_changeset/3` for a list of supported options.
